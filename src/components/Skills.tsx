...
const Skills = () => {
  ...
  return (
    <section id="skills" ref={ref} className="min-h-screen flex items-center py-32 bg-[#0f0f23]">
      <div className="max-w-6xl mx-auto px-4 sm:px-8 w-full">
        <motion.div
          ...
          className="mb-20"
        >
          <h2 className="text-7xl font-black text-white mb-4" style={{ textShadow: '6px 6px 0px #6366f1' }}>
            SKILLS
          </h2>
        ...
        <div className="space-y-6">
          {skills.map((skill, i) => (
            <motion.div
              ...
              className="group p-6 border-4 border-white/20 shadow-[8px_8px_0px_0px_rgba(99,102,241,0.3)] hover:shadow-[12px_12px_0px_0px_rgba(99,102,241,0.5)] hover:-translate-x-2 hover:-translate-y-2 transition-all cursor-pointer"
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-6">
                  ...
                  <span className="text-3xl font-black text-white group-hover:scale-110 transition-transform inline-block">{skill.name}</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-lg text-white font-bold">{skill.count} projects</span>
                  <div className="w-12 h-12 border-4 border-white bg-white/10 flex items-center justify-center group-hover:rotate-180 transition-transform duration-500">
