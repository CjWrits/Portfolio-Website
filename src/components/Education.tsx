...
const Education = () => {
  ...
  return (
    <section id="education" ref={ref} className="min-h-screen flex items-center py-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-8 w-full relative z-10">
        ...
        >
          ...
          <div className="relative border-l-4 border-orange-500 pl-8">
            <h3 className="text-4xl font-bold text-white mb-2">{education.degree}</h3>
            <p className="text-2xl text-orange-500 mb-4">{education.field}</p>
            <p className="text-xl text-gray-400 mb-2">{education.university}</p>
            <p className="text-gray-500 font-mono">{education.period}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {certifications.map((cert, i) => (
            ...
            >
              ...
              <div className="relative p-8 border border-gray-800 group-hover:border-orange-500 transition-all">
                <div className="text-orange-500 font-mono text-sm mb-4">{cert.year}</div>
